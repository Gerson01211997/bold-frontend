export const className = {
  ...
  infoIcon: "w-4 h-auto text-white",
  amount: "text-2xl font-bold bg-bold-gradient bg-clip-text text-transparent",
  date: "font-medium text-gray-500",
  tooltip:
    "absolute left-1/2 top-full z-10 mt-2 w-max -translate-x-1/2 rounded-md bg-gray-900 text-xs text-white px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap shadow-lg min-w[150px]",
} as const;
